    ...
    <div className="w-screen flex h-15 bg-blue-700 p-5 text-white fixed justify-between items-center z-50 mb-auto md:h-15 lg:w-[80vw] select-none print-hidden">
      ...
      <div>
        ...
        <ul className="hidden md:flex items-center gap-12">
          <li className="p-3 hover:bg-blue-500 cursor-pointer transition-all" onClick={() => scrollToSection("part1")}>PHẦN I</li>
          <li className="p-3 hover:bg-blue-500 cursor-pointer transition-all" onClick={() => scrollToSection("part2")}>PHẦN II</li>
          <li className="p-3 hover:bg-blue-500 cursor-pointer transition-all" onClick={() => scrollToSection("part3")}>PHẦN III</li>
        </ul>
      </div>
