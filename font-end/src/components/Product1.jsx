...
const Product1 = ({
    ...
    return (
        <div className="w-screen h-screen flex flex-col mt-5">
            <div className="flex flex-col w-full h-full md:flex-row md:justify-center md:items-center mt-30">
            <div className=" md:w-40 md:h-40 bg-blue-700 z-10 relative -top-95 -left-10"></div>
                ...
                <div className=" w-full h-60 flex  justify-center items-center md:w-1/3 md:h-full">
                    <img src={imageData[0]} className="w-30 h-50 md:w-60 md:h-120">
                    </img>
                </div>
            ...
            <div className="w-screen h-8 !important bg-blue-700 mt-auto relative">
