...
const Home = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden flex flex-col justify-between items-center md:flex-row select-none " >
      ...
      <div className="absolute mt-100 z-10 flex md:mt-0 md:ml-120 ">
        ...
        <div className="flex flex-col ">
          ...
          <div className="text-blue-500 text-8xl font-bold   mt-8 ml-8  font-montserrat">{company?.name}</div>
